...
import '../owner_payment_history_controller.dart';
import '../../detail/widgets/detail_page.dart';

class OwnerPaymentHistoryPage extends StatelessWidget {
  const OwnerPaymentHistoryPage({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(OwnerPaymentHistoryController());
